...
<div class="page-header">
    <h1 class="title text-uppercase">Gerenciar: <b>Estado</b></h1>
</div>
...
@if( isset($errors) && count($errors) > 0 )
    ...
    <form class="form" method="post" action="/painel/estados/edt/{{$data->id}}">
        {{csrf_field()}}
        ...
        <form class="form" method="post" action="/painel/estados/del/{{$data->id}}">
            {{csrf_field()}}
            <div class="form-group">
                <label>Nome do Estado</label>
            ...
            <form class="form" method="post" action="/painel/estados/add">
                {{csrf_field()}}
                <div class="form-group">
                    <label>Nome do Estado</label>
                    <input type="text" name="nome" placeholder="Ex: 'edita_paises'" value="{{ $data->nome or old('nome')  }}" class="form-control" >
